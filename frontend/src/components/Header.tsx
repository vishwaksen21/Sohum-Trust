    ...
    <header className="sticky top-0 z-50 bg-white/98 backdrop-blur-sm border-b border-orange-100/40 shadow-sm">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          {/* CTA */}
          <Button className="bg-orange-500 hover:bg-orange-600 text-white px-6 md:px-8 py-2 md:py-2.5 rounded-full shadow-md hover:shadow-lg transition-all duration-200 font-semibold text-sm md:text-base">
            Donate Now
          </Button>
