    ...
    <section ref={ref} className="py-16 bg-gradient-to-b from-white/80 to-amber-50/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            Sohum Trust envisions an India where every individual accesses transformative education tailored to their aspirations. Our mission integrates, operates, and elevates educational ecosystems—spanning primary academies to specialized research hubs—ensuring equitable opportunities rooted in India's vibrant heritage.
          </motion.p>
        </motion.div>
      </div>
    </section>
